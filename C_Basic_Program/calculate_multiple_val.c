...
{
    int num1 , num2;
    // The given number is taken in a integer type of varible so, the num1/num2 are variable
    ...
    float div, mul; 
    // This is a suitable variables for collect each values its means like decimal values 
    ...
    add = num1 + num2;
     // In which the addition two numbers over here
    
    sub = num1 - num2; // In which the subtraction two numbers over here
    
    mul = num1 * num2;
    // In which the multiplication two numbers over here
    
    div = num1 / num2;
     // In which the division two numbers over here
